                                ...
                                <div class="row g-4 p-3">
                                    @forelse ($post->galleries as $gallery)
                                        <div class="col-6 col-md-4 col-lg-3">
                                            ...
                                            <a class="venobox" data-gall="gallery" data-maxwidth="600px"
                                                href="{{ asset('storage/gallery/' . $gallery->photo) }}">
                                                <img src="{{ asset('storage/gallery/' . $gallery->photo) }}"
                                                    class="img-fluid rounded" alt="image alt" />
                                            </a>
                                        </div>
                                    @empty
                                    @endforelse
                                        ...
                                        @forelse($post->comments as $comment)
                                            <div class="border rounded p-3 mb-3">
                                                <div class="d-flex justify-content-between mb-3">
                                                    <div class="d-flex">
                                                        <img src="{{ isset($comment->user->profile_photo)? asset('storage/thumbnail/' . $comment->user->profile_photo): asset('default-avatar.png') }}"
                                    ...
                                    @auth
                                        <form action="{{ route('comment.store') }}" method="post" id="comment-create"
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control @error('text') is-invalid @enderror" name="text" placeholder="Leave a comment here"
                                                    style="height: 150px" id="floatingTextarea"></textarea>
                                        ...
                                        <div class="d-md-flex justify-content-md-between align-items-md-center">
                                            ...
                                            <div class="d-flex align-items-center mt-4 mt-md-0">
                                                @auth
                                                    ...
                                                    @endcan
                                                @endauth
                                                <a href="{{ route('index') }}" class="btn btn-outline-primary">Read
                                                    All</a>
                                            </div>
                                        </div>
                                    </div>
